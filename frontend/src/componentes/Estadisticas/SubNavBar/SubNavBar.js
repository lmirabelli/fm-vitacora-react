...
export const SubNavBar = ({activar}) => {
    ...
    return(
        <div className="botonera-flotante bf-derecha">
            ...
            {location !== "/estadisticas" && <Link to="/estadisticas/goles/veteranos" className={`btn-flotante ${activar === "veteranos" ? "activo" : "desactivo"}`} style={{animationDelay: `${0.25 * 7}s`}} title="veteranos">👴🏻​</Link>}
        </div>
    )
} 